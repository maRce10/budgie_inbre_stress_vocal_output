...
# order levels
foxp2$Treatment <- factor(foxp2$Treatment, levels = c("CONTROL", "MEDIUM", "HIGH"))


gg_foxp2 <- ggplot(data = foxp2,
       aes(x = Treatment, y = FoxP2.Counts.MMSt.Striatum, fill = Treatment)) +
    geom_boxplot() + geom_point() +
    scale_x_discrete(labels = c("CONTROL" = "Control", "MEDIUM" = "Medium\nstress",
        "HIGH" = "High\nstress")) +
    scale_fill_viridis_d(begin = 0.1, end = 0.9) +

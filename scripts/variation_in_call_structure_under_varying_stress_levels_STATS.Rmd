...
for (x in 1:length(physio_models)) 
    extended_summary(physio_models[[x]], gsub.pattern = "b_treatment|b_", gsub.replacement = "", highlight = FALSE, remove.intercepts = TRUE)
...
for (x in 1:length(behav_models)) 
    extended_summary(behav_models[[x]], gsub.pattern = "b_treatment|b_", gsub.replacement = "", highlight = FALSE, remove.intercepts = TRUE)
...
check_rds_fits(path = "./data/processed", html = TRUE, verbose = FALSE)
